    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-10">
                <div class="text-center my-5">
                    ...
                    <p class="fs-5">Os associados e demais interessado em divulgar seu criatório ou produto no nosso site oficial,
                        deverão
        ...
        <div class="row align-items-center">
                ...
                <div id="noticias-carousel" class="carousel slide w-100" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption">
                                <a href="#" class="text-light text-decoration-none hover-underline">
                                    <h5 class="mx-auto" id="titulo">Título da Notícia 1</h5>
                                    <p class="fs-6 descricao-card">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                        Esse sed minus, aut consectetur
                                        distinctio recusandae delectus mollitia, placeat cumque porro iusto eum quaerat
                                        labore
                                        dolorum quam blanditiis quasi dolorem dolore?
                                    </p>
                                </a>
                            </div>
                        </div>
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                <a href="#" class="text-light text-decoration-none hover-underline">
                                    <h5 class="mx-auto" id="titulo">Título da Notícia 2</h5>
                                    <p class="fs-6 descricao-card">Descrição da Notícia 2</p>
                                </a>
                            </div>
                        </div>
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                <a href="#" class="text-light text-decoration-none hover-underline">
                                    <h5 class="mx-auto" id="titulo">Título da Notícia 3</h5>
                                    <p class="fs-6 descricao-card">Descrição da Notícia 3</p>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 mb-5">
                <div class="p-2 d-flex justify-content-center align-items-center h-100">
                    <div class="text-center">
                        <p class="fs-2 text-secondary">Cadastre seu criatório do nosso mapa!</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-5 d-flex justify-content-center">
                <a href="#" class="btn btn-custom rounded-fill fs-5">Solicitar serviço</a>
            </div>
        </div>
    </div>
@endsection
